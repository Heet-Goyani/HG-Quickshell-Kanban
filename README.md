# [Quicksell Frontend Application](https://heetgoyani-quickshell-kanban.onrender.com)
...
You can see a live demo of the Kanban board application [here](https://heetgoyani-quickshell-kanban.onrender.com).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Heet-Goyani/HG-Quickshell-Kanban.git
   ```
